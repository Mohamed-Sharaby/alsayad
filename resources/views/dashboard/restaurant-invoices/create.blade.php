...
@section('title',' اضافة   اذن صرف جديد')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="header-title m-t-0 m-b-30"> اضافة اذن صرف جديد</h4>

                            {!!Form::open( ['route' => 'admin.restaurant-invoices.store', 'method' => 'Post','role'=>'form','class'=>'form-horizontal',
                                'files'=>true,
                                'x-data'=>'invoiceForm',
                                ]) !!}
