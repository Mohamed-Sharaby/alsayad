...
{{--                                تعديل جرد رقم--}}
{{--                                <span class="badge badge-info">{{$inventory->code}}</span>--}}
{{--                            </h4>--}}
                            {!! Form::model($inventory,['route'=>['admin.inventories.update',$inventory->id],'method'=>'PUT','role'=>'form','class'=>'form-horizontal',          'files'=>true,
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('inventoryForm', () => ({
                ...
                row_products: @json($inventory->inventoryItems),
