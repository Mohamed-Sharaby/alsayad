...
<div class="form-group row">
    <label class="col-md-2 control-label">المنتجات</label>
    <div class="col-md-10">
        {!! Form::select('product_id[]',$products,isset($supplier) ? $supplier->products : null,['class' =>'form-control select2'.($errors->has('product_id') ? ' is-invalid' : null) ,'multiple' ]) !!}
        @error('product_id')
        <div class="invalid-feedback" style="color: #ef1010">
            {{ $message }}
        </div>
